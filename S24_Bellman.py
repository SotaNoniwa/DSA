...
class BellmanFordAlgorithm:
    ...
    def find_shortest_path(self):
        ...
        # Bellman-Ford algo has V-1 iterations
        ...
        # After all iterations, check for negative cycles
        for edge in self.edge_list:
    ...
    def check_cycle(self, edge):
        ...
        # in other words, if they are equal, there's no negative cycle
    ...
    def get_shortest_path(self, vertex):
        if not self.has_cycle:
            print("Shortest path exists with total edge weight: ", vertex.min_distance)
            node = vertex
